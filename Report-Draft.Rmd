...
basic_barplot(my_df = compute_perc(monthly_salary_data %>% filter(gender_35 == "Woman"), monthly_salary_28), 
              a_factor = monthly_salary_28, its_values = perc, labels = perc_label,
              title = "")
...
basic_barplot(my_df = compute_perc(monthly_salary_data %>% filter(gender_35 == "Man"), monthly_salary_28), 
              a_factor = monthly_salary_28, its_values = perc, labels = perc_label,
              title = "")
