...
barplot_ordered(my_df = compute_perc(Qs, company_size_23 ), 
...
ggplot(compute_perc(Qs,weekly_work_hours_24), aes(x=weekly_work_hours_24)) + geom_histogram(color = "white", fill= HL_colors[1], binwidth = 20) + labs(x="Weekly working hours", y = "Number of Respondents") +
...
50% of the respondents earn less than 2000 GHS per month whereas women 
```{r}
