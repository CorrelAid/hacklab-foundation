...
barplot_ordered <- function(my_df, a_factor, its_values, labels, title){
  ...
  current_plot <- ggplot(data = my_df, 
    ...
    geom_chicklet(radius = grid::unit(1, 'mm'), fill = highlight_col) +
    # FAT LOLLIPOP
    # geom_point(color = highlight_col, size = 10) + 
    # geom_segment(aes(x={{a_factor}}, xend={{a_factor}}, 
    #                  y=0, yend={{its_values}}), 
    #              color = highlight_col,
    #              size = 1.5) +
    # geom_text(
    #   aes(label = {{labels}}, y = {{its_values}}),
    #   size = 2.5,
    #   color = "white",
    #   fontface = "bold"
  # ) +
...
```{r, fig.align='center', out.width = '100%', fig.height=1.8}
...
runningcounts.df <- as.data.frame(table(company_size_23_NA_remov$company_size_23, company_size_23_NA_remov$monthly_salary_28))
...
runningcounts.df <- as.data.frame(table(company_size_23_NA_remov_prof$company_size_23, company_size_23_NA_remov_prof$monthly_salary_28))
...
runningcounts.df <- as.data.frame(table(company_size_23_NA_remov_stud$company_size_23, company_size_23_NA_remov_stud$monthly_salary_28))
...
runningcounts.df <- as.data.frame(table(Qs$highest_edu_18, Qs$monthly_salary_28))
