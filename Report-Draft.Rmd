...
Most of the respondents are full-time employees. There is also a great share of students. Sadly, there is also a significant share of unemployed developers looking for work. 
...
_TypeScript_, followed by _Python_ and _Swift_ are the technologies that professional developers do not use but want to learn. Students are interested in "the classics": _Python_, _SQL_, and _JavaScript_.
...
Respondents want to learn working with cloud platforms, in particular _AWS_ for the professional developers and _Microsoft Azure_ for the students. Almost 20% of professional developers indicated wanting to learn _Docker_. _iOS_ is the mobile developing system that most want to work with next year.        
...
### Wannted Other Frameworks, Libraries and Tools
...
_Microsoft Azure_ and _Stack Overflow for Teams_ are tools who might become more popular. Many students also indicated wanting to learn _GitHub_.  
...
levels(relation_ordinal_Q19_28$monthly_salary_28) <- gsub("than ", "than\n", 
                                                          levels(relation_ordinal_Q19_28$monthly_salary_28))
...
levels(prim_study_19_28_prof$monthly_salary_28) <- gsub("than ", "than\n", 
                                                          levels(prim_study_19_28_prof$monthly_salary_28))
...
Only respondents who indicated being professional developers are included in the chart.  
...
A Bachelor's degree is associated with broad range of salary options. There are respondents with a Bachelors degree who receive salaries as high as respondents with Master's degree. However, people with a Master's degree tend to have higher salaries than others on average. Only respondents who indicated being professional developers are included. 
