...
colours_4 = c("#58AFE2", "#AA738A", "#E04B4F","#8E87A7")
colours_6 = c("#58AFE2","#739BC5", "#8E87A7","#AA738A", "#C55F6C", "#E04B4F")
...
levels(relation_ordinal_Q19_28$prim_study_19) <- sub("Mathematics/Statistics", "Mathematics/\nStatistics", levels(relation_ordinal_Q19_28$prim_study_19))
levels(relation_ordinal_Q19_28$prim_study_19) <- sub("Web-Development/Web-Design", "Web-Development/\nWeb-Design", levels(relation_ordinal_Q19_28$prim_study_19))
levels(relation_ordinal_Q19_28$monthly_salary_28) <- sub("Greater than GHS 15,000", ">GHS\n15,000", levels(relation_ordinal_Q19_28$monthly_salary_28))
levels(relation_ordinal_Q19_28$monthly_salary_28) <- sub("Less than GHS 1,500", "<GHS\n1,500", levels(relation_ordinal_Q19_28$monthly_salary_28))
...
#### How do Study Field, Degree and Salary Relate to Each Other for Professional Developers?
...
names(colours_4) <- levels(prim_study_19_28_prof$highest_edu_18)
...
barplot_ordered(my_df = compute_perc(change_edu_filt, change_edu_21 ), 
...
Interestingly, respondents who work more than 3 times a week overtime are satisfied with their job. There seems no relationship between overtime  work and  job satisfaction. The tendency is rather the opposite. 
...
levels(relation_ordinal_Q25_28$monthly_salary_28) <- sub("Greater than GHS 15,000", ">GHS\n15,000", levels(relation_ordinal_Q25_28$monthly_salary_28))
levels(relation_ordinal_Q25_28$monthly_salary_28) <- sub("Less than GHS 1,500", "<GHS\n1,500", levels(relation_ordinal_Q25_28$monthly_salary_28))
...
levels(relation_ordinal_Q23_28$monthly_salary_28) <- sub("Greater than GHS 15,000", ">GHS\n15,000", levels(relation_ordinal_Q23_28$monthly_salary_28))
levels(relation_ordinal_Q23_28$monthly_salary_28) <- sub("Less than GHS 1,500", "<GHS\n1,500", levels(relation_ordinal_Q23_28$monthly_salary_28))
...
levels(relation_ordinal_Q18_28$monthly_salary_28) <- sub("Greater than GHS 15,000", ">GHS\n15,000", levels(relation_ordinal_Q18_28$monthly_salary_28))
levels(relation_ordinal_Q18_28$monthly_salary_28) <- sub("Less than GHS 1,500", "<GHS\n1,500", levels(relation_ordinal_Q18_28$monthly_salary_28))
