...
levels(runningcounts.df$overtime_work_25) <- gsub(" ", "\n", levels(runningcounts.df$overtime_work_25))
levels(runningcounts.df$job_satisfaction_22) <- gsub(" ", "\n", levels(runningcounts.df$job_satisfaction_22))

heatmap_Q22_Q25 <- runningcounts.df %>% rename()
ggplot(runningcounts.df, aes(Var2, Var1)) +
