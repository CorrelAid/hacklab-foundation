...
ggplot(compute_perc(Qs,weekly_work_hours_24), aes(x=weekly_work_hours_24)) + geom_histogram(color = "black", fill= HL_colors[1]) + labs(x="Weekly working hours", y = "Number of Respondents") +
