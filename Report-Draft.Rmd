...
**5. more than two in three respondents are members of a developer community:**  
...
This network graph shows which technologies are mostly used together by the respondents. Every time a respondent mentioned using technologies, a link is drawn between them on the graph. Well connected technologies, having many "co-mentions", are thus often used together.  

![](./backbone-weighted.png)

The most popular technologies, such as PHP, SQL, Python, JavaScript, and HTML are often used together, in the same ecosystem, used by the same developers.   
...
There seems to be a tendency that a higher salary is associated with overtime work, however there a a lot of respondents who have salary in the lower range and still work more than 3 days per week overtime. Only respondents who indicated being professional developers are included in the plot. 
...
how_learn_about_company_31_split <-how_learn_about_company_31_split %>% 
  mutate(how_learn_about_company_31 = recode(how_learn_about_company_31, 
                                             ...
                                             "Google & their website" = "Read company media, such as employees blogs\nor company culture videos",
                                             "linkedin" = "Read company media, such as employees blogs\nor company culture videos",
                                             "Online (Linkedin" = "Read company media, such as employees blogs\nor company culture videos",
                                             "Websites " = "Read company media, such as employees blogs\nor company culture videos",
