...
colours_7 = c( "#E04B4F", "#C55F6C", "#AA738A", "#8E87A7", "#739BC5", "#58AFE2", "#000000")

names(colours_7) <- levels(relation_ordinal_Q23_28$company_size_23)
colScale <- scale_colour_manual(name = "company_size_23",values = colours_7)
