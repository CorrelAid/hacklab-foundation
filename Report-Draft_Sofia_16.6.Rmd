...
basic_barplot <- function(my_df, a_factor, its_values, labels, title){
  ...
  # needs an factor as input, and its values
  # returns a ggplot
  # REORDERS FACTOR IN FUNCTION OF ITS VALUES
...
# Assign colors to study fields
colours_11 = c( "#E04B4F", "#D4545C", "#C75D6A", "#C55F6C", "#AA738A", "#BB6677", "#AF6F84", "#8E87A7", "#739BC5", "#58AFE2", "#000000", "#000001", "pink", "green", "blue", "grey", "red", "steelblue", "orange", "purple")
...
### From Q18, if you could go back and change your educational path (but end up in the same career), what would you change?
...
ggplot(compute_perc(Qs,weekly_work_hours_24), aes(x=weekly_work_hours_24)) + geom_histogram(color = "white", fill= highlight_col, binwidth = 10) + labs(x="Weekly working hours", y = "Number of Respondents") +
...
(By on-boarding, we mean the structured process of getting you settled in to your new role at a company)
...
barplot_ordered(my_df = compute_perc(improve_onboarding_27_filt, improve_onboarding_27), 
              ...
              title = "27. How could on-boarding at your company be improved?")

```

### How much is your monthly salary in Ghana Cedis?

50% of the respondents earn less than 2000 GHS per month. [**NEED ALSO TO DETAIL BY PROFESSIONAl/STUDENTS**]
...
##### Only Professional Developers {.panel-name}
```{r, fig.align='center', out.width = '100%', fig.height=3}
company_size_23_NA_remov_prof <- Qs %>%
  filter(company_size_23 != "NA" & profession_1 == "I am a developer by profession")
>>>>>>> main
...
=======
company_size_23_NA_remov_stud <- Qs %>%
  filter(company_size_23 != "NA" & profession_1 == "I am a student who is learning to code")
>>>>>>> main
...
=======
#### Relationship between Highest Education and Salary
>>>>>>> main
...
colours_6 = c( "#E04B4F", "#C55F6C", "#AA738A", "#8E87A7", "#739BC5", "#58AFE2", "#000000")
...
bubble_Q18_28<-bubble_plot(df = relation_ordinal_Q18_28, x_value = highest_edu_18, y_value = monthly_salary_28, freq = Freq, colour_choice = colours, title = "") + bubble_plotly_theme()
...
```{r, fig.align='center', out.width = '100%', fig.height=1.5}
