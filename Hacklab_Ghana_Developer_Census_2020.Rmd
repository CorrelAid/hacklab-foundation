...
We are committed to building on steps we have taken and improving the coverage, insights and beyond in the coming years to better improve the support and interventions needed to give developers a more enabling ecosystem to thrive. Some of these survey's results directly guide those efforts.     

We looked at breakdowns by demographics throughout our analysis and its reflection of the distribution of talents. To address the characteristics of our data, be sure to check out where we summarize results by developer persona (Professional Developer, Student) or gender.    
