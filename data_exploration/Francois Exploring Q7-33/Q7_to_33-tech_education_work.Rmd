...
HL_font = "Open Sans" # !!! Should change and use Gotham !!!
main_fontsize = 7 
...
# TODO
* add tabs detailing dev and students for "each" plot
* skills (Q8-13)
...
* Always plot in percentage and do not care about NAs? ==> YES
...
basic_barplot(my_df = compute_perc(Qs, new_tool_7), 
              ...
              title = "Q7. How frequently do you learn a new language or framework?")
...
basic_barplot(my_df = compute_perc(Qs, prim_opsyst_14), 
              ...
              title = "Q14. What is the primary operating system in which you work?")
...
basic_barplot(my_df = compute_perc(Qs, rather_opsyst_15), 
              ...
              title = "Q15. In which operating system would you rather work?")
...
basic_barplot(my_df = compute_perc(Qs, highest_edu_18), 
              ...
              title = "Q18. Which of the following best describes the highest level of formal education that you have completed?")
...
basic_barplot(my_df = compute_perc(Qs, prim_study_19), 
              ...
              title = "Q19. What was your primary field of study?")
...
basic_barplot(my_df = compute_perc(Qs, edu_importance_20 ), 
              ...
              title = "Q20. How important is a formal education, such as a university degree in computer science, to your career?")
...
basic_barplot(my_df = compute_perc(Qs, drivers_for_new_jobs_30 ), 
              ...
              title = "Q30. In general, what drives you to look for a new job?")
